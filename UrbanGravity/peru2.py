...
# Description: 
# The goal is to show the growth of nighttime lights from 1992-2013 in Peru, viewing only the growth, in cities over 100k in population.
...
env.workspace = r"F:\TimData\UrbanGravity\Peru\timeseries"

# Check out the ArcGIS Spatial Analyst extension license
arcpy.CheckOutExtension("Spatial")

# create list of file locations to save outputs
filelist = [r"F:\TimData\UrbanGravity\Peru\timeseries\polygon" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\dissolve" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\UrbanAreaPop" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\SpatialJoin" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\Merge" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\ZonalStats" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\project" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\erase" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries" + "\\", 
            r"F:\TimData\UrbanGravity\Peru\timeseries\dissolve2" + "\\",
            r"F:\TimData\UrbanGravity\Peru\timeseries\setnull8_raster" + "\\",
...
raster1992 = "F101992.v4b_web.stable_lights.avg_vis.tif_peruclip.tif_6.tif"
