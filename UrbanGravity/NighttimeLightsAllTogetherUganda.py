...
#Description: 
# The goal is to show the growth of nighttime lights from 1992-2013, viewing only the growth, in cities over a certain size in population.
...
# only new lights will be viewed. Only nighttime lights belonging to cities above a certain population (65k) are considered. A table showing 
# the area of the extent of pixels (essentially the urban extent) is created. This table also contains the number of 
...
env.workspace = r"F:\TimData\UrbanGravity\Uganda\timeseries"

#Check out the ArcGIS Spatial Analyst extension license
arcpy.CheckOutExtension("Spatial")

#create list of file locations to save outputs
filelist = [r"F:\TimData\UrbanGravity\Uganda\timeseries\polygon" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\dissolve" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\UrbanAreasPop" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\SpatialJoin" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\Merge" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\ZonalStats" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\project" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\erase" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries" + "\\",\
            r"F:\TimData\UrbanGravity\Uganda\timeseries\dissolve2" + "\\",
            r"F:\TimData\UrbanGravity\Uganda\timeseries\setnull0_raster" + "\\"]
...
pnt = "Uganda_50kpop.shp"
'''
#first set zero to null in raster list 
for ras in ras_list:
    # Define name and location of output data
    name10 =str(ras) + "_zero.tif" 
    # Execute set null
    outNull = SetNull(ras, ras,"\"Value\" = 0")
...
env.workspace = r"F:\TimData\UrbanGravity\Uganda\timeseries\setnull0_raster"
...
for ras in ras_list:
    ...
    # Execute clip
    arcpy.RasterToPolygon_conversion(ras, filelist[0] + name, "NO_SIMPLIFY", "VALUE")
    ...
    arcpy.SelectLayerByLocation_management (filelist[1] + namefl, "INTERSECT", pnt, "#", "NEW_SELECTION")
    ...
    arcpy.SpatialJoin_analysis(filelist[2] + name3, pnt, filelist[3] + name4, "JOIN_ONE_TO_MANY", "KEEP_ALL", "#", "INTERSECT", "#","#")   
...
for poly3 in polylist3:
    ...
    arcpy.Project_management(poly3, filelist[6] + name9, "PROJCS['WGS_1984_UTM_Zone_36N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID\
    ...
    ['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',33.0],PARAMETER['Scale_Factor',0.9996],PARAMETER\
    ['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]", "", "GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],\
