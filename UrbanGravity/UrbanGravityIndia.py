...
'''
# Description: 
# The goal is to show the growth of nighttime lights from 1992-2013, viewing only the growth, in cities over 500k in population in India.
...
env.workspace = r"F:\TimData\UrbanGravity\India\timeseries"

# Check out the ArcGIS Spatial Analyst extension license
arcpy.CheckOutExtension("Spatial")

# create list of file locations to save outputs
filelist = [r"F:\TimData\UrbanGravity\India\timeseries\polygon" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\dissolve" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\UrbanAreaPop" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\SpatialJoin" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\Merge" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\ZonalStats" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\project" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\erase" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries" + "\\", 
            r"F:\TimData\UrbanGravity\India\timeseries\dissolve2" + "\\",
            r"F:\TimData\UrbanGravity\India\timeseries\setnull13_raster" + "\\",
            r"F:\TimData\UrbanGravity\India\timeseries\IndiaClip" + "\\"]
...
pnt = "India_750kpop.shp"
india = "IndiaBoundary.shp"

# first set zero to null in raster list 
for ras in ras_list:
    # Define name and location of output data
    name10 = str(ras) + "_13.tif" 
    # Execute set null
    outNull = SetNull(ras, ras, "\"Value\" < 13")
